  ...
  return (
    <div className='flex items-center mt-8 text-white'>
        <ul className='flex space-x-4 w-full justify-evenly items-center'>
            <li className='github hover:scale-125 lg:w-20 hover:text-blue-400 w-15 sm:text-blue-400 '>
            ...
            <li className='github hover:scale-125 lg:w-20 hover:text-gray-700 w-15 sm:text-gray-700'>
                <a className=' hover:scale-125 animate-bounce' href="https://x.com/abhpinran98">
                    <FontAwesomeIcon icon={faXTwitter} size="2xl" />

                </a>
            </li>
            <li className='github hover:scale-125 lg:w-20 hover:text-red-400 w-15 sm:text-red-400'>
                <a className=' hover:scale-125 animate-bounce' href="https://github.com/Abhishek-kumar00">
